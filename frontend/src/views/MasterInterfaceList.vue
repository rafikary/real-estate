<template>
  <div class="list-view">
    <div class="card">
      <h2 class="card-title" style="border: none; margin-bottom: 10px; padding: 0;">Master Interface</h2>
      ...
      <div class="action-bar">
        ...
        <div class="action-buttons-group">
          <router-link to="/master/interface/create" class="btn-create">
        ...
        <table class="data-table">
          ...
          <tbody>
            ...
            <tr v-else-if="records.length === 0">
              <td colspan="5" style="text-align: center; padding: 30px;">Tidak ada data ditemukan.</td>
            </tr>
...
const editRecord = (id) => {
  router.push(`/master/interface/${id}/edit`);
};
